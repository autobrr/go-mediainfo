...
var textStreamFieldOrder = map[string]int{
	...
	"Channel(s)":                        27,
	"Channel(s)_Original":               28,
	"ChannelLayout_Original":            28,
	"Channel layout":                    28,
	"Sampling rate":                     29,
	"Frame rate mode":                   30,
	"Frame rate":                        31,
	...
	"Forced":                            53,
	"Complexity index":                  53,
	"Number of dynamic objects":         53,
	"Bed channel count":                 53,
	"Bed channel configuration":         53,
	"Dialog Normalization":              53,
	"bsid":                              53,
	"dsurmod":                           53,
	"acmod":                             53,
	"lfeon":                             53,
	...
	"Matrix coefficients":               57,
	"Mastering display color primaries": 57,
	"Mastering display luminance":       57,
	"Maximum Content Light Level":       57,
	"Maximum Frame-Average Light Level": 57,
	"Alternate group":                   58,
	"Codec configuration box":           59,
	"List":                              60,
	"Service name":                      61,
	"Service provider":                  62,
	"Service type":                      63,
