...
- Known remaining: `Errors: Missing ID_END` tracked in issue #34; `Count of elements` on tiny synthetic text tracks; TS controls have drifted vs official on main (pre-existing, unrelated to Matroska work; e.g. `Nickelodeon Generic` default-text diff `41` for both main and this branch).
